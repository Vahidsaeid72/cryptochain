...
describe("Block", () => {
  ...
  describe("mineBlock()", () => {
    ...
    it("sets a `timestamp` in the next time", () => {
   ...
   describe("adjustDifficulty()", () => {
    ...
    it("addjust the difficulty()", () => {
      const possibleResults = [block.difficulty + 1, block.difficulty - 1];
      expect(possibleResults.includes(Block.adjustDifficulty({ originalBlock: block, timestamp: block.timestamp + 360000 }))).toBe(true);
    });
   });
